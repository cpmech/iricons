...
export const IconCodeSlash: React.FC<IconCodeSlashProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
