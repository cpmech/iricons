export interface IconAmericanFootballProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconAmericanFootball: React.FC<IconAmericanFootballProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
