export interface IconLogoGitlabProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconLogoGitlab: React.FC<IconLogoGitlabProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
