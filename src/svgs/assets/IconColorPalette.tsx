export interface IconColorPaletteProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconColorPalette: React.FC<IconColorPaletteProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
