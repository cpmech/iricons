export interface IconCalendarNumberProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconCalendarNumber: React.FC<IconCalendarNumberProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
