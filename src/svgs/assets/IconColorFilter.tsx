export interface IconColorFilterProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconColorFilter: React.FC<IconColorFilterProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
