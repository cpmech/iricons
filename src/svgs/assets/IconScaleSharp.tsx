...
export const IconScaleSharp: React.FC<IconScaleSharpProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
