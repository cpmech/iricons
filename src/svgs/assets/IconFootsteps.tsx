...
export const IconFootsteps: React.FC<IconFootstepsProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
