...
export const IconLogoPaypal: React.FC<IconLogoPaypalProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
