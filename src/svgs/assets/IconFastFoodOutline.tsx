...
export const IconFastFoodOutline: React.FC<IconFastFoodOutlineProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
