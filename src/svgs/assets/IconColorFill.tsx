export interface IconColorFillProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconColorFill: React.FC<IconColorFillProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
