export interface IconLogoPlaystationProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconLogoPlaystation: React.FC<IconLogoPlaystationProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
