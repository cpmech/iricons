export interface IconBoatProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconBoat: React.FC<IconBoatProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
