export interface IconUmbrellaProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconUmbrella: React.FC<IconUmbrellaProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
