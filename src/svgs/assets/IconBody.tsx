export interface IconBodyProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconBody: React.FC<IconBodyProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
