export interface IconEarProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconEar: React.FC<IconEarProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
