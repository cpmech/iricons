export interface IconLogoIonitronProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconLogoIonitron: React.FC<IconLogoIonitronProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
