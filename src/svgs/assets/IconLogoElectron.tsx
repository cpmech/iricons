export interface IconLogoElectronProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconLogoElectron: React.FC<IconLogoElectronProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
