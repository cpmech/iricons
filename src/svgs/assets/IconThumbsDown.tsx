export interface IconThumbsDownProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconThumbsDown: React.FC<IconThumbsDownProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
