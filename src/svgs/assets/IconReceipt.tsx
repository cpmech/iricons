export interface IconReceiptProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconReceipt: React.FC<IconReceiptProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
