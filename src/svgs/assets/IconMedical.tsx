export interface IconMedicalProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconMedical: React.FC<IconMedicalProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
