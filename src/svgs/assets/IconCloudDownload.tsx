export interface IconCloudDownloadProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconCloudDownload: React.FC<IconCloudDownloadProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
