...
export const IconNewspaperOutline: React.FC<IconNewspaperOutlineProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
