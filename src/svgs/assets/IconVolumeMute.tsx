export interface IconVolumeMuteProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconVolumeMute: React.FC<IconVolumeMuteProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
