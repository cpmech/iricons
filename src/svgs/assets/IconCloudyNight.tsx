export interface IconCloudyNightProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconCloudyNight: React.FC<IconCloudyNightProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
