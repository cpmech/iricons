export interface IconTransgenderProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconTransgender: React.FC<IconTransgenderProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
