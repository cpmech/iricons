export interface IconLogoAmazonProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconLogoAmazon: React.FC<IconLogoAmazonProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
