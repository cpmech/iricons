export interface IconBaseballProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconBaseball: React.FC<IconBaseballProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
