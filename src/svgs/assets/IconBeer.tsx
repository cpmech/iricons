export interface IconBeerProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconBeer: React.FC<IconBeerProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
