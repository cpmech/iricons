export interface IconLogoSteamProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconLogoSteam: React.FC<IconLogoSteamProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
