export interface IconLogoOctocatProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconLogoOctocat: React.FC<IconLogoOctocatProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
