export interface IconNuclearProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconNuclear: React.FC<IconNuclearProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
