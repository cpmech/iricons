export interface IconMegaphoneProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconMegaphone: React.FC<IconMegaphoneProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
