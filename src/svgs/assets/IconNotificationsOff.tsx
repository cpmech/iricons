export interface IconNotificationsOffProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconNotificationsOff: React.FC<IconNotificationsOffProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
