export interface IconIdCardProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconIdCard: React.FC<IconIdCardProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
