...
export const IconBalloonSharp: React.FC<IconBalloonSharpProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
