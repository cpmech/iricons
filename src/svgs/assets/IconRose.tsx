export interface IconRoseProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconRose: React.FC<IconRoseProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
