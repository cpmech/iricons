export interface IconLogoMastodonProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconLogoMastodon: React.FC<IconLogoMastodonProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
