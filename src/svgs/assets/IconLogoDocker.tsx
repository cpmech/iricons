export interface IconLogoDockerProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconLogoDocker: React.FC<IconLogoDockerProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
