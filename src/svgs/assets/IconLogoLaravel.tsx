export interface IconLogoLaravelProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconLogoLaravel: React.FC<IconLogoLaravelProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
