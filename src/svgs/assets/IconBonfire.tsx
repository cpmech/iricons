export interface IconBonfireProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconBonfire: React.FC<IconBonfireProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
