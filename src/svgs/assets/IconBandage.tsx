export interface IconBandageProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconBandage: React.FC<IconBandageProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
