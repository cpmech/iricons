...
export const IconConstructOutline: React.FC<IconConstructOutlineProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
