export interface IconLogoPythonProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconLogoPython: React.FC<IconLogoPythonProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
