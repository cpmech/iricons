...
export const IconVideocamOff: React.FC<IconVideocamOffProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
