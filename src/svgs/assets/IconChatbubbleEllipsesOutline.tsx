export interface IconChatbubbleEllipsesOutlineProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconChatbubbleEllipsesOutline: React.FC<IconChatbubbleEllipsesOutlineProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
