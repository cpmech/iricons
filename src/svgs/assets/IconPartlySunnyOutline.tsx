...
export const IconPartlySunnyOutline: React.FC<IconPartlySunnyOutlineProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
