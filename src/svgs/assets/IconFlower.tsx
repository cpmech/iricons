...
export const IconFlower: React.FC<IconFlowerProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
