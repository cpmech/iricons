export interface IconLogoFoursquareProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconLogoFoursquare: React.FC<IconLogoFoursquareProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
