...
export const IconFlowerSharp: React.FC<IconFlowerSharpProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
