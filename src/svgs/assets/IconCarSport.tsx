export interface IconCarSportProps {
  size?: string; // size of square container
  style?: React.CSSProperties; // not for height or width
}

export const IconCarSport: React.FC<IconCarSportProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
