...
export const IconHardwareChip: React.FC<IconHardwareChipProps> = ({ size = '24px', style }) => {
  return (
    <div
      style={{
        display: 'inline-flex',
